...
/*
 * Parse and set a datetime value in request, interpreting in a timezone.
 ...
 * The third parameter is the timezone to interpret in.
 * The timezone defaults to the Laravel app's timezone setting if omitted.
 *
 * Example for route definition:
 * 'middleware' => 'reformulator.datetime:booking_start'
 *
 * Example for controller:
 * $this->middleware('reformulator.datetime:booking_start_local,booking_start_text,Europe/Stockholm');
 *
 */
